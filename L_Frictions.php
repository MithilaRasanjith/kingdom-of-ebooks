...
<head>
    <meta charset="utf-8" />
    <title>Search your book | Literary Frictions</title>
        ...
        <div class="tbl2">
            <table border="0">
                ...
                <tr>
                    <td></td>
                    <td colspan="5">
                        <h1 class="topic">LITERARY FRICTIONS</h1>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <a href="#"><button id="btnn2">LITERARY FRICTIONS</button></a><br />
                    ...
                    <td>
                        <img class="book" src="Images/N70.jpg" />
                        <img class="book" src="Images/N71.jpg" />
                        <img class="book" src="Images/N72.jpg" />
                        <img class="book" src="Images/N73.jpg" />
                        <img class="book" src="Images/N74.jpg" />
                        <img class="book" src="Images/N75.jpg" />
                        <img class="book" src="Images/N76.jpg" />
                        <img class="book" src="Images/N77.jpg" />
                        <img class="book" src="Images/N78.jpg" />
                        <img class="book" src="Images/N79.jpg" />
                        <img class="book" src="Images/N80.jpg" />
                        <img class="book" src="Images/N81.jpg" />
                        <img class="book" src="Images/N82.jpg" />
                        <img class="book" src="Images/N83.jpg" />
                        <img class="book" src="Images/N84.jpg" />
                        <img class="book" src="Images/N85.jpg" />
                        <img class="book" src="Images/N86.jpg" />
                        <img class="book" src="Images/N87.jpg" />
                    </td>
                </tr>
            </table>
        </div>
