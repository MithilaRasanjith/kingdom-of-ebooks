...
<head>
    <meta charset="utf-8" />
    <title>Search your book | Science Frictions</title>
        ...
        <div class="tbl2">
            <table border="0">
                ...
                <tr>
                    <td></td>
                    <td colspan="5">
                        <h1 class="topic">SCEINCE FRICTIONS</h1>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <a href="#"><button id="btnn2">SCIENCE FRICTIONS</button></a><br />
                    ...
                    <td>
                        <img class="book" src="Images/N52.jpg" />
                        <img class="book" src="Images/N53.jpg" />
                        <img class="book" src="Images/N54.jpg" />
                        <img class="book" src="Images/N55.jpg" />
                        <img class="book" src="Images/N56.jpg" />
                        <img class="book" src="Images/N57.jpg" />
                        <img class="book" src="Images/N58.jpg" />
                        <img class="book" src="Images/N59.jpg" />
                        <img class="book" src="Images/N60.jpg" />
                        <img class="book" src="Images/N61.jpg" />
                        <img class="book" src="Images/N62.jpg" />
                        <img class="book" src="Images/N63.jpg" />
                        <img class="book" src="Images/N64.jpg" />
                        <img class="book" src="Images/N65.jpg" />
                        <img class="book" src="Images/N66.jpg" />
                        <img class="book" src="Images/N67.jpg" />
                        <img class="book" src="Images/N68.jpg" />
                        <img class="book" src="Images/N69.jpg" />
                    </td>
                </tr>
            </table>
        </div>
